...
class LaporanTransaksiBahanBakuController extends Controller
{
    public function index(Request $request)
    {
    	return view('pages.admin.laporan.bahan_baku.index');
    }
    ...
    public function cetakExcel(Request $request)
	{
        ...
        $sheet->setCellValue('A2', 'REKAP TRANSAKSI PENGELUARAN UNTUK BAHAN BAKU');
        ...
        $sheet->setCellValue('B7', 'Nama Bahan');
		...
		foreach ($transaksi as $row) {
            ...
            $sheet->setCellValue('B'.$i, $row->Bahan->nama);
        ...
        $namafile = 'laporan-transaksi-pengeluaran-bahanbaku-'.bulanIndo($request->bulan).'-'.$request->tahun.'.xlsx';
