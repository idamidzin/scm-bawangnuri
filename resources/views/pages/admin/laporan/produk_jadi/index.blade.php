...
<div class="content-heading">
	<div>
		Laporan Transaksi Pendapatan dari Produk Jadi
	</div>
</div>
<div class="container">
	<div class="row">
			...
			<div class="card">
				<div class="card-body" id="card-body">
					<div class="card card-default">
						<div class="card-header">Rekap Transaksi Pendapatan dari Produk Jadi</div>
						<div class="card-body">
							<form id="form-laporan" target="_blank" action="{{route('admin.laporan.transaksi.produk_jadi.cetak')}}" method="POST">
								@csrf
								<div class="form-row">
									<div class="col-sm-4">
